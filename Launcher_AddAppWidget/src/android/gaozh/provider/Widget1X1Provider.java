 ...
 * @author qinjuning
 */
public class Widget1X1Provider extends BaseWidgetProvider
{
    public void updateWidgetView(Context context, boolean isDefaultIcon)
    {
        ...
        appWidgetManager.updateAppWidget(new ComponentName(context, Widget1X1Provider.class), remoteViews);
    }

    public RemoteViews getRemoteViews(Context context)
    {
        // 初始化remoteView对象
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widget_change_image_1_1);
